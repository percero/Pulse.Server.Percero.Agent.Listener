...
@JsonSerialize(using=BDOSerializer.class)
@JsonDeserialize(using=BDODeserializer.class)
@JoinColumn(name="ImpersonatesTeamLeaderId")
@org.hibernate.annotations.ForeignKey(name="FK_ImpersonatesTeamLeaderOfImpersonatedByTeamLeaderImpersonation")
@ManyToOne(fetch=FetchType.LAZY, optional=false)
private TeamLeader impersonatesTeamLeader;
public TeamLeader getImpersonatesTeamLeader() {
	return this.impersonatesTeamLeader;
}

public void setImpersonatesTeamLeader(TeamLeader value) {
	this.impersonatesTeamLeader = value;
}
...
objectJson += ",\"impersonatesTeamLeader\":";
		if (getImpersonatesTeamLeader() == null)
			objectJson += "null";
		else {
			try {
				objectJson += ((BaseDataObject) getImpersonatesTeamLeader()).toEmbeddedJson();
			} catch(Exception e) {
				objectJson += "null";
			}
		}
	...
	protected void fromJson(JsonObject jsonObject) {
		...
		this.impersonatesTeamLeader = (TeamLeader) JsonUtils.getJsonPerceroObject(jsonObject, "impersonatesTeamLeader");
