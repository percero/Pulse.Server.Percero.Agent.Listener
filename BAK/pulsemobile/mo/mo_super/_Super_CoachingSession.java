...
@JsonSerialize(using=BDOSerializer.class)
@JsonDeserialize(using=BDODeserializer.class)
@OneToMany(fetch=FetchType.LAZY, targetEntity=Scorecard.class, mappedBy="coachingSession", cascade=javax.persistence.CascadeType.REMOVE)
...
objectJson += ",\"coachingSessionMeasures\":[";
		...
		objectJson += "]";
//Retrieve value of the Coaching Session of Scorecard relationship
...
objectJson += ",\"qualityEvaluations\":[";
	...
	protected List<MappedClassMethodPair> getListSetters() {
		...
		listSetters.add(MappedClass.getFieldSetters(Scorecard.class, "coachingsession"));
