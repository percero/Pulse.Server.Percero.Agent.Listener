...
@MappedSuperclass
public class _Super_ActivityType extends BaseDataObject implements Serializable
{
	//////////////////////////////////////////////////////
	// VERSION
	//////////////////////////////////////////////////////
...
@OneToMany(fetch=FetchType.LAZY, targetEntity=ScheduledTimeEntry.class, mappedBy="activityType", cascade=javax.persistence.CascadeType.REMOVE)
...
objectJson += ",\"scheduledTimeEntries\":[";
	...
	protected List<MappedClassMethodPair> getListSetters() {
		...
		// Target Relationships
		listSetters.add(MappedClass.getFieldSetters(ScheduledTimeEntry.class, "activitytype"));
