...
@MappedSuperclass
public class _Super_ScheduledActivityCode extends BaseDataObject implements Serializable
{
	//////////////////////////////////////////////////////
	// VERSION
	//////////////////////////////////////////////////////
...
@OneToMany(fetch=FetchType.LAZY, targetEntity=ScheduledTimeEntry.class, mappedBy="scheduledActivityCode", cascade=javax.persistence.CascadeType.REMOVE)
...
objectJson += ",\"scheduledTimeEntries\":[";
	...
	protected List<MappedClassMethodPair> getListSetters() {
		...
		// Target Relationships
		listSetters.add(MappedClass.getFieldSetters(ScheduledTimeEntry.class, "scheduledactivitycode"));
