...
//
//@Component
//public class ScorecardWeeklyScoreCWHelper extends DerivedValueChangeWatcherHelper {
//
//	private static final Logger log = Logger.getLogger(ScorecardWeeklyScoreCWHelper.class);
//
//	public static final String PREVIOUS_SCORECARD_WEEKLY_SCORE = "previousScorecardWeeklyScore";
//
//	@Override
...
//		} catch(Exception e) {}
//
//		if (PREVIOUS_SCORECARD_WEEKLY_SCORE.equalsIgnoreCase(fieldName)) {
//			try {
//				result = calc_previousScorecardWeeklyScore(pair, PREVIOUS_SCORECARD_WEEKLY_SCORE);
//				postCalculate(fieldName, pair, params, result, oldValue);
//			} catch(Exception e) {
//				log.error("Unable to calculate " + PREVIOUS_SCORECARD_WEEKLY_SCORE, e);
//			}
//		}
//		else {
...
//	}
//
//	private ClassIDPair calc_previousScorecardWeeklyScore(ClassIDPair pair, String derivedValueName) {
//		ClassIDPair result = null;
//
//		try {
//			ScorecardWeeklyScore host = (ScorecardWeeklyScore) syncAgentService.systemGetById(pair);
//			if (host == null) {
...
//
//			ScorecardWeeklyScore previousScorecardWeeklyScore = null;
...
//								accessManager.addWatcherField(BaseDataObject.toClassIdPair(nextScorecardWeeklyScore), "endDate", fieldsToWatch);
//								Date nextEndDate = nextScorecardWeeklyScore.getEndDate();
//
...
//										previousScorecardWeeklyScore = nextScorecardWeeklyScore;
//										previousEndDate = previousScorecardWeeklyScore.getEndDate();
//									}
//								}
//							}
//
...
//			}
//
//			if (previousScorecardWeeklyScore != null) {
//				result = BaseDataObject.toClassIdPair(previousScorecardWeeklyScore);
//			}
//
