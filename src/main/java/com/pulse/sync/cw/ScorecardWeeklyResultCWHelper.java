...
//				accessManager.addWatcherField(BaseDataObject.toClassIdPair(agentScorecard), "agent", fieldsToWatch);
...
//					Iterator<ScorecardMonthlyResult> itrMonthlyResults = agent.getScorecardMonthlyResults().iterator();
...
//						ScorecardMonthlyResult nextMonthlyResult = syncAgentService.systemGetByObject(itrMonthlyResults.next());
