...
@MappedSuperclass
public class _Super_CorrectiveActionState extends BaseDataObject implements Serializable
{
	//////////////////////////////////////////////////////
	// VERSION
	//////////////////////////////////////////////////////
...
@OneToMany(fetch=FetchType.LAZY, targetEntity=CorrectiveAction.class, mappedBy="correctiveActionState", cascade=javax.persistence.CascadeType.REMOVE)
...
objectJson += ",\"correctiveActions\":[";
	...
	protected List<MappedClassMethodPair> getListSetters() {
		...
		// Target Relationships
		listSetters.add(MappedClass.getFieldSetters(CorrectiveAction.class, "correctiveactionstate"));
