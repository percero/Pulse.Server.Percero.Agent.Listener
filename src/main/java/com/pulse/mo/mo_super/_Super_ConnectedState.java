...
@OneToMany(fetch=FetchType.LAZY, targetEntity=UserSession.class, mappedBy="connectedState", cascade=javax.persistence.CascadeType.REMOVE)
...
objectJson += ",\"userSessions\":[";
	...
	protected List<MappedClassMethodPair> getListSetters() {
		...
		// Target Relationships
		listSetters.add(MappedClass.getFieldSetters(UserSession.class, "connectedstate"));
