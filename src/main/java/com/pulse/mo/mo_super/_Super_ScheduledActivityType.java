...
@MappedSuperclass
public class _Super_ScheduledActivityType extends BaseDataObject implements Serializable
{
	//////////////////////////////////////////////////////
	// VERSION
	//////////////////////////////////////////////////////
...
@OneToMany(fetch=FetchType.LAZY, targetEntity=ScheduledTimeEntry.class, mappedBy="scheduledActivityType", cascade=javax.persistence.CascadeType.REMOVE)
...
objectJson += ",\"scheduledTimeEntries\":[";
	...
	protected List<MappedClassMethodPair> getListSetters() {
		...
		// Target Relationships
		listSetters.add(MappedClass.getFieldSetters(ScheduledTimeEntry.class, "scheduledactivitytype"));
