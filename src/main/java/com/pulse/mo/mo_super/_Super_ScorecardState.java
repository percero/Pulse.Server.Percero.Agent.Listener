...
@MappedSuperclass
public class _Super_ScorecardState extends BaseDataObject implements Serializable
{
	//////////////////////////////////////////////////////
	// VERSION
	//////////////////////////////////////////////////////
...
@OneToMany(fetch=FetchType.LAZY, targetEntity=Scorecard.class, mappedBy="scorecardState", cascade=javax.persistence.CascadeType.REMOVE)
...
objectJson += ",\"scorecards\":[";
	...
	protected List<MappedClassMethodPair> getListSetters() {
		...
		// Target Relationships
		listSetters.add(MappedClass.getFieldSetters(Scorecard.class, "scorecardstate"));
