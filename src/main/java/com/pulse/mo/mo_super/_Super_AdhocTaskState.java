...
@MappedSuperclass
public class _Super_AdhocTaskState extends BaseDataObject implements Serializable
{
	//////////////////////////////////////////////////////
	// VERSION
	//////////////////////////////////////////////////////
...
@OneToMany(fetch=FetchType.LAZY, targetEntity=AdhocTask.class, mappedBy="adhocTaskState", cascade=javax.persistence.CascadeType.REMOVE)
...
objectJson += ",\"adhocTasks\":[";
	...
	protected List<MappedClassMethodPair> getListSetters() {
		...
		// Target Relationships
		listSetters.add(MappedClass.getFieldSetters(AdhocTask.class, "adhoctaskstate"));
