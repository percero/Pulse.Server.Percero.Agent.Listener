...
@MappedSuperclass
public class _Super_EmployeeAcknowledgement extends BaseDataObject implements Serializable
{
	//////////////////////////////////////////////////////
	// VERSION
	//////////////////////////////////////////////////////
	...
	/*
	Keys of EmployeeAcknowledgement
	*/
	//////////////////////////////////////////////////////
// ID
//////////////////////////////////////////////////////
...
@com.percero.agents.sync.metadata.annotations.Externalize
@OneToOne(fetch=FetchType.LAZY, mappedBy="employeeAcknowledgement", cascade=javax.persistence.CascadeType.REMOVE)
