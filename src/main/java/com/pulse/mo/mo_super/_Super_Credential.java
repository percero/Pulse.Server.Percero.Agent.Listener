...
@MappedSuperclass
public class _Super_Credential extends BaseDataObject implements Serializable
{
	//////////////////////////////////////////////////////
	// VERSION
	//////////////////////////////////////////////////////
...
public void setPulseUser(PulseUser value) {
	...
	public String retrieveJson(ObjectMapper objectMapper) {
		...
		// Properties		
		//Retrieve value of the Password property
		objectJson += ",\"password\":";
		...
		if (getPassword() == null)
			...
			try {
				objectJson += objectMapper.writeValueAsString(getPassword());
