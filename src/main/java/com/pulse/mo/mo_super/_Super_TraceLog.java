...
@MappedSuperclass
public class _Super_TraceLog extends BaseDataObject implements Serializable
{
	//////////////////////////////////////////////////////
	// VERSION
	//////////////////////////////////////////////////////
...
@OneToMany(fetch=FetchType.LAZY, targetEntity=TraceEntry.class, mappedBy="traceLog", cascade=javax.persistence.CascadeType.REMOVE)
...
objectJson += ",\"traceEntries\":[";
	...
	protected List<MappedClassMethodPair> getListSetters() {
		...
		// Target Relationships
		listSetters.add(MappedClass.getFieldSetters(TraceEntry.class, "tracelog"));
