...
*/
    ...
    @com.percero.agents.sync.metadata.annotations.PropertyInterface(entityInterfaceClass=com.percero.agents.auth.vo.IUserAnchor.class, propertyName="employeeId",params={})
    @com.percero.agents.sync.metadata.annotations.Externalize
