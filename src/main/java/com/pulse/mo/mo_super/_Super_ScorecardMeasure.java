...
@JsonSerialize(contentUsing=BDOSerializer.class)
@JsonDeserialize(contentUsing=BDODeserializer.class)
@OneToMany(fetch=FetchType.LAZY, targetEntity=DevelopmentPlan.class, mappedBy="scorecardMeasure", cascade=javax.persistence.CascadeType.REMOVE)
...
objectJson += ",\"behaviorResponses\":[";
		...
		objectJson += "]";
//Retrieve value of the Scorecard Measure of Development Plan relationship
