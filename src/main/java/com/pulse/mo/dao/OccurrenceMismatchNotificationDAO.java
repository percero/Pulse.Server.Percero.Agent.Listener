...
//	public static final String CONNECTION_FACTORY_NAME = "jdbc:mysql://pulse.cta6j6w4rrxw.us-west-2.rds.amazonaws.com:3306/Pulse?autoReconnect=true";
	...
	protected String getSelectStarSQL() {
		return "SELECT OCCURRENCE_MISMATCH_NOTIF.ID,OCCURRENCE_MISMATCH_NOTIF.MESSAGE,OCCURRENCE_MISMATCH_NOTIF.NAME,OCCURRENCE_MISMATCH_NOTIF.AUX_CODE_ENTRY_NAME,OCCURRENCE_MISMATCH_NOTIF.AUX_MODE_EVENT_COUNT,OCCURRENCE_MISMATCH_NOTIF.DATE,OCCURRENCE_MISMATCH_NOTIF.TIMECARD_ACTIVITY_EVENT_COUNT,OCCURRENCE_MISMATCH_NOTIF.TIMECARD_ACTIVITY_NAME,OCCURRENCE_MISMATCH_NOTIF.TYPE,OCCURRENCE_MISMATCH_NOTIF.AGENT_ID,OCCURRENCE_MISMATCH_NOTIF.LOB_CONFIGURATION_ID,OCCURRENCE_MISMATCH_NOTIF.TEAM_LEADER_ID,OCCURRENCE_MISMATCH_NOTIF.CMS_AUX_MODE_ID FROM OCCURRENCE_MISMATCH_NOTIF OCCURRENCE_MISMATCH_NOTIF WHERE OCCURRENCE_MISMATCH_NOTIF.ID=?";
	}
	...
	protected String getSelectAllStarSQL() {
		return "SELECT OCCURRENCE_MISMATCH_NOTIF.ID,OCCURRENCE_MISMATCH_NOTIF.MESSAGE,OCCURRENCE_MISMATCH_NOTIF.NAME,OCCURRENCE_MISMATCH_NOTIF.AUX_CODE_ENTRY_NAME,OCCURRENCE_MISMATCH_NOTIF.AUX_MODE_EVENT_COUNT,OCCURRENCE_MISMATCH_NOTIF.DATE,OCCURRENCE_MISMATCH_NOTIF.TIMECARD_ACTIVITY_EVENT_COUNT,OCCURRENCE_MISMATCH_NOTIF.TIMECARD_ACTIVITY_NAME,OCCURRENCE_MISMATCH_NOTIF.TYPE,OCCURRENCE_MISMATCH_NOTIF.AGENT_ID,OCCURRENCE_MISMATCH_NOTIF.LOB_CONFIGURATION_ID,OCCURRENCE_MISMATCH_NOTIF.TEAM_LEADER_ID,OCCURRENCE_MISMATCH_NOTIF.CMS_AUX_MODE_ID FROM OCCURRENCE_MISMATCH_NOTIF OCCURRENCE_MISMATCH_NOTIF ORDER BY OCCURRENCE_MISMATCH_NOTIF.ID";
	}
	
	@Override
	protected String getSelectAllStarWithLimitAndOffsetSQL() {
		return "SELECT OCCURRENCE_MISMATCH_NOTIF.ID,OCCURRENCE_MISMATCH_NOTIF.MESSAGE,OCCURRENCE_MISMATCH_NOTIF.NAME,OCCURRENCE_MISMATCH_NOTIF.AUX_CODE_ENTRY_NAME,OCCURRENCE_MISMATCH_NOTIF.AUX_MODE_EVENT_COUNT,OCCURRENCE_MISMATCH_NOTIF.DATE,OCCURRENCE_MISMATCH_NOTIF.TIMECARD_ACTIVITY_EVENT_COUNT,OCCURRENCE_MISMATCH_NOTIF.TIMECARD_ACTIVITY_NAME,OCCURRENCE_MISMATCH_NOTIF.TYPE,OCCURRENCE_MISMATCH_NOTIF.AGENT_ID,OCCURRENCE_MISMATCH_NOTIF.LOB_CONFIGURATION_ID,OCCURRENCE_MISMATCH_NOTIF.TEAM_LEADER_ID,OCCURRENCE_MISMATCH_NOTIF.CMS_AUX_MODE_ID FROM OCCURRENCE_MISMATCH_NOTIF OCCURRENCE_MISMATCH_NOTIF ORDER BY OCCURRENCE_MISMATCH_NOTIF.ID LIMIT ? OFFSET ?";
	}
	...
	protected String getSelectInStarSQL() {
		return "SELECT OCCURRENCE_MISMATCH_NOTIF.ID,OCCURRENCE_MISMATCH_NOTIF.MESSAGE,OCCURRENCE_MISMATCH_NOTIF.NAME,OCCURRENCE_MISMATCH_NOTIF.AUX_CODE_ENTRY_NAME,OCCURRENCE_MISMATCH_NOTIF.AUX_MODE_EVENT_COUNT,OCCURRENCE_MISMATCH_NOTIF.DATE,OCCURRENCE_MISMATCH_NOTIF.TIMECARD_ACTIVITY_EVENT_COUNT,OCCURRENCE_MISMATCH_NOTIF.TIMECARD_ACTIVITY_NAME,OCCURRENCE_MISMATCH_NOTIF.TYPE,OCCURRENCE_MISMATCH_NOTIF.AGENT_ID,OCCURRENCE_MISMATCH_NOTIF.LOB_CONFIGURATION_ID,OCCURRENCE_MISMATCH_NOTIF.TEAM_LEADER_ID,OCCURRENCE_MISMATCH_NOTIF.CMS_AUX_MODE_ID FROM OCCURRENCE_MISMATCH_NOTIF OCCURRENCE_MISMATCH_NOTIF WHERE OCCURRENCE_MISMATCH_NOTIF.ID IN (?)";
	}
	...
	protected String getSelectByRelationshipStarSQL(String joinColumnName) {
		return "SELECT OCCURRENCE_MISMATCH_NOTIF.ID,OCCURRENCE_MISMATCH_NOTIF.MESSAGE,OCCURRENCE_MISMATCH_NOTIF.NAME,OCCURRENCE_MISMATCH_NOTIF.AUX_CODE_ENTRY_NAME,OCCURRENCE_MISMATCH_NOTIF.AUX_MODE_EVENT_COUNT,OCCURRENCE_MISMATCH_NOTIF.DATE,OCCURRENCE_MISMATCH_NOTIF.TIMECARD_ACTIVITY_EVENT_COUNT,OCCURRENCE_MISMATCH_NOTIF.TIMECARD_ACTIVITY_NAME,OCCURRENCE_MISMATCH_NOTIF.TYPE,OCCURRENCE_MISMATCH_NOTIF.AGENT_ID,OCCURRENCE_MISMATCH_NOTIF.LOB_CONFIGURATION_ID,OCCURRENCE_MISMATCH_NOTIF.TEAM_LEADER_ID,OCCURRENCE_MISMATCH_NOTIF.CMS_AUX_MODE_ID FROM OCCURRENCE_MISMATCH_NOTIF OCCURRENCE_MISMATCH_NOTIF WHERE OCCURRENCE_MISMATCH_NOTIF." + joinColumnName + "=?";
	}
	...
	protected String getFindByExampleSelectAllStarSQL() {
		return "SELECT OCCURRENCE_MISMATCH_NOTIF.ID,OCCURRENCE_MISMATCH_NOTIF.MESSAGE,OCCURRENCE_MISMATCH_NOTIF.NAME,OCCURRENCE_MISMATCH_NOTIF.AUX_CODE_ENTRY_NAME,OCCURRENCE_MISMATCH_NOTIF.AUX_MODE_EVENT_COUNT,OCCURRENCE_MISMATCH_NOTIF.DATE,OCCURRENCE_MISMATCH_NOTIF.TIMECARD_ACTIVITY_EVENT_COUNT,OCCURRENCE_MISMATCH_NOTIF.TIMECARD_ACTIVITY_NAME,OCCURRENCE_MISMATCH_NOTIF.TYPE,OCCURRENCE_MISMATCH_NOTIF.AGENT_ID,OCCURRENCE_MISMATCH_NOTIF.LOB_CONFIGURATION_ID,OCCURRENCE_MISMATCH_NOTIF.TEAM_LEADER_ID,OCCURRENCE_MISMATCH_NOTIF.CMS_AUX_MODE_ID FROM OCCURRENCE_MISMATCH_NOTIF OCCURRENCE_MISMATCH_NOTIF ";
	}
	
	@Override
	protected String getInsertIntoSQL() {
		return "INSERT INTO OCCURRENCE_MISMATCH_NOTIF (ID,MESSAGE,NAME,AUX_CODE_ENTRY_NAME,AUX_MODE_EVENT_COUNT,DATE,TIMECARD_ACTIVITY_EVENT_COUNT,TIMECARD_ACTIVITY_NAME,TYPE,AGENT_ID,LOB_CONFIGURATION_ID,TEAM_LEADER_ID,CMS_AUX_MODE_ID) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
	}
	
	@Override
	protected String getUpdateSet() {
		return "UPDATE OCCURRENCE_MISMATCH_NOTIF SET MESSAGE=?,NAME=?,AUX_CODE_ENTRY_NAME=?,AUX_MODE_EVENT_COUNT=?,DATE=?,TIMECARD_ACTIVITY_EVENT_COUNT=?,TIMECARD_ACTIVITY_NAME=?,TYPE=?,AGENT_ID=?,LOB_CONFIGURATION_ID=?,TEAM_LEADER_ID=?,CMS_AUX_MODE_ID=? WHERE ID=?";
	}
