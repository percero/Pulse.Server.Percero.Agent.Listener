...
//	public static final String CONNECTION_FACTORY_NAME = "jdbc:mysql://pulse.cta6j6w4rrxw.us-west-2.rds.amazonaws.com:3306/Pulse?autoReconnect=true";
	...
	protected String getSelectStarSQL() {
		return "SELECT site.ID,site.name,site.externalID FROM Site site WHERE site.ID=?";
	}
	...
	protected String getSelectAllStarSQL() {
		return "SELECT site.ID,site.name,site.externalID FROM Site site ORDER BY site.ID";
	}
	
	@Override
	protected String getSelectAllStarWithLimitAndOffsetSQL() {
		return "SELECT site.ID,site.name,site.externalID FROM Site site ORDER BY site.ID LIMIT ? OFFSET ?";
	}
	...
	protected String getSelectInStarSQL() {
		return "SELECT site.ID,site.name,site.externalID FROM Site site WHERE site.ID IN (?)";
	}
	...
	protected String getSelectByRelationshipStarSQL(String joinColumnName) {
		return "SELECT site.ID,site.name,site.externalID FROM Site site WHERE site." + joinColumnName + "=?";
	}
	...
	protected String getFindByExampleSelectAllStarSQL() {
		return "SELECT site.ID,site.name,site.externalID FROM Site site ";
	}
	
	@Override
	protected String getInsertIntoSQL() {
		return "INSERT INTO Site (ID,name,externalID) VALUES (?,?,?)";
	}
	
	@Override
	protected String getUpdateSet() {
		return "UPDATE Site SET name=?,externalID=? WHERE ID=?";
	}
