...
//	public static final String CONNECTION_FACTORY_NAME = "jdbc:mysql://pulse.cta6j6w4rrxw.us-west-2.rds.amazonaws.com:3306/Pulse?autoReconnect=true";
	...
	public static final String SHELL_ONLY_SELECT = "\"CORRECTIVE_ACTION_TYPE\".\"ID\"";
	...
	protected String getSelectByRelationshipShellOnlySQL(String joinColumnName) 
	{
		...
		return "SELECT " + SHELL_ONLY_SELECT + " " + selectFromStatementTableName + " WHERE \"CORRECTIVE_ACTION_TYPE\"." + joinColumnName + "=?";
	}
	...
	protected String getInsertIntoSQL() {
		return "INSERT INTO TBL_CORRECTIVE_ACTION_TYPE (\"ID\",\"NAME\",\"DESCRIPTION\") VALUES (?,?,?)";
	}
...
CorrectiveActionType nextResult = null;
    	
		    	
    	if (nextResult == null) {
    		nextResult = new CorrectiveActionType();
    	}
...
propertyCounter++;
...
public CorrectiveActionType createObject(CorrectiveActionType perceroObject, String userId)
	...
	Statement stmt = null;
	String query = "Select CORRECTIVE_ACTION_TYPE_SEQ.NEXTVAL from dual";
	String sql = null;
	String insertedId = "0";
	int result = 0;
	try {
