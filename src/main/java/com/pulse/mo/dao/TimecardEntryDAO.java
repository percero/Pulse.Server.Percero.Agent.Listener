...
//	public static final String CONNECTION_FACTORY_NAME = "jdbc:mysql://pulse.cta6j6w4rrxw.us-west-2.rds.amazonaws.com:3306/Pulse?autoReconnect=true";
	public static final String CONNECTION_FACTORY_NAME = "convergys.agent--time--entry--vw";
	
	//TODO:For use refactoring, so we set it once
	public static final String SQL_VIEW = "SELECT  \"TIMECARD_ENTRY\".\"ID\" as \"ID\", \"TIMECARD_ENTRY\".\"MINUTES\" as \"DURATION\", \"TIMECARD_ENTRY\".\"CODE\" as \"ACTION_CODE\", '' as \"ACTION_NAME\", \"TIMECARD_ENTRY\".\"ON_TIME\" as \"FROM_TIME\", '' as \"NOTIFICATION_DETECTED\", \"TIMECARD_ENTRY\".\"OFF_TIME\" as \"TO_TIME\", \"TIMECARD_ENTRY\".\"CENTRE\" as \"ESTART_PROJECT_NAME\", '' as \"NOTIFICATION_RESOLVED\", \"TIMECARD_ENTRY\".\"POS\" as \"ACTIVITY_NAME\", \"TIMECARD\".\"WORKED_ID\" as \"TIMECARD_ID\", \"AGENT\".\"PAYROLL\" as \"AGENT_ID\", '' as \"TIMECARD_ACTIVITY_ID\" FROM \"PAYROLL\" \"TIMECARD_ENTRY\" ";
	...
	protected String getSelectShellOnlySQL() {
		return "SELECT \"TIMECARD_ENTRY\".\"ID\" as \"ID\" FROM \"PAYROLL\" \"TIMECARD_ENTRY\" WHERE \"TIMECARD_ENTRY\".\"ID\"=?";
	}
	...
	protected String getSelectAllShellOnlySQL() {
		return "SELECT \"TIMECARD_ENTRY\".\"ID\" as \"ID\" FROM \"PAYROLL\" \"TIMECARD_ENTRY\" ORDER BY ID";
	}
	
	@Override
	protected String getSelectAllShellOnlyWithLimitAndOffsetSQL() {
		return "SELECT \"TIMECARD_ENTRY\".\"ID\" as \"ID\" FROM \"PAYROLL\" \"TIMECARD_ENTRY\" ORDER BY \"TIMECARD_ENTRY\".ID LIMIT ? OFFSET ?";
	}
	...
	protected String getCountAllSQL() {
		return "SELECT COUNT(ID) FROM \"PAYROLL\" \"TIMECARD_ENTRY\"";
	}
	...
	protected String getSelectInShellOnlySQL() {
		return "SELECT \"TIMECARD_ENTRY\".\"ID\" as \"ID\" FROM \"PAYROLL\" \"TIMECARD_ENTRY\" WHERE \"TIMECARD_ENTRY\".ID IN (?)";
	}
	...
	protected String getSelectByRelationshipShellOnlySQL(String joinColumnName) {
		return "SELECT \"TIMECARD_ENTRY\".\"ID\" as \"ID\" FROM \"PAYROLL\" \"TIMECARD_ENTRY\" WHERE \"TIMECARD_ENTRY\"." + joinColumnName + "=?";
	}

	@Override
	protected String getFindByExampleSelectShellOnlySQL() {
		return "SELECT \"TIMECARD_ENTRY\".\"ID\" as \"ID\" FROM \"PAYROLL\" \"TIMECARD_ENTRY\" ";
	}
