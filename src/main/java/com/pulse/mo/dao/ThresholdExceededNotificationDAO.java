...
//	public static final String CONNECTION_FACTORY_NAME = "jdbc:mysql://pulse.cta6j6w4rrxw.us-west-2.rds.amazonaws.com:3306/Pulse?autoReconnect=true";
	...
	protected String getSelectShellOnlySQL() {
		return "SELECT thresholdexceedednotification.ID FROM ThresholdExceededNotification thresholdexceedednotification WHERE thresholdexceedednotification.ID=?";
	}
	
	@Override
	protected String getSelectStarSQL() {
		return "SELECT thresholdexceedednotification.ID,thresholdexceedednotification.externalID,thresholdexceedednotification.message,thresholdexceedednotification.name,thresholdexceedednotification.date,thresholdexceedednotification.type,thresholdexceedednotification.agent_ID,thresholdexceedednotification.lOBConfiguration_ID,thresholdexceedednotification.teamLeader_ID,thresholdexceedednotification.lOBConfigurationEntry_ID FROM ThresholdExceededNotification thresholdexceedednotification WHERE thresholdexceedednotification.ID=?";
	}
	
	@Override
	protected String getSelectAllShellOnlySQL() {
		return "SELECT thresholdexceedednotification.ID FROM ThresholdExceededNotification thresholdexceedednotification ORDER BY ID";
	}
	
	@Override
	protected String getSelectAllShellOnlyWithLimitAndOffsetSQL() {
		return "SELECT thresholdexceedednotification.ID FROM ThresholdExceededNotification thresholdexceedednotification ORDER BY thresholdexceedednotification.ID LIMIT ? OFFSET ?";
	}
	
	@Override
	protected String getSelectAllStarSQL() {
		return "SELECT thresholdexceedednotification.ID,thresholdexceedednotification.externalID,thresholdexceedednotification.message,thresholdexceedednotification.name,thresholdexceedednotification.date,thresholdexceedednotification.type,thresholdexceedednotification.agent_ID,thresholdexceedednotification.lOBConfiguration_ID,thresholdexceedednotification.teamLeader_ID,thresholdexceedednotification.lOBConfigurationEntry_ID FROM ThresholdExceededNotification thresholdexceedednotification ORDER BY thresholdexceedednotification.ID";
	}
	...
	protected String getCountAllSQL() {
		return "SELECT COUNT(ID) FROM ThresholdExceededNotification thresholdexceedednotification";
	}
	
	@Override
	protected String getSelectInStarSQL() {
		return "SELECT thresholdexceedednotification.ID,thresholdexceedednotification.externalID,thresholdexceedednotification.message,thresholdexceedednotification.name,thresholdexceedednotification.date,thresholdexceedednotification.type,thresholdexceedednotification.agent_ID,thresholdexceedednotification.lOBConfiguration_ID,thresholdexceedednotification.teamLeader_ID,thresholdexceedednotification.lOBConfigurationEntry_ID FROM ThresholdExceededNotification thresholdexceedednotification WHERE thresholdexceedednotification.ID IN (?)";
	}
	
	@Override
	protected String getSelectInShellOnlySQL() {
		return "SELECT thresholdexceedednotification.ID FROM ThresholdExceededNotification thresholdexceedednotification WHERE thresholdexceedednotification.ID IN (?)";
	}

	@Override
	protected String getSelectByRelationshipStarSQL(String joinColumnName) {
		return "SELECT thresholdexceedednotification.ID,thresholdexceedednotification.externalID,thresholdexceedednotification.message,thresholdexceedednotification.name,thresholdexceedednotification.date,thresholdexceedednotification.type,thresholdexceedednotification.agent_ID,thresholdexceedednotification.lOBConfiguration_ID,thresholdexceedednotification.teamLeader_ID,thresholdexceedednotification.lOBConfigurationEntry_ID FROM ThresholdExceededNotification thresholdexceedednotification WHERE thresholdexceedednotification." + joinColumnName + "=?";
	}
	
	@Override
	protected String getSelectByRelationshipShellOnlySQL(String joinColumnName) {
		return "SELECT thresholdexceedednotification.ID FROM ThresholdExceededNotification thresholdexceedednotification WHERE thresholdexceedednotification." + joinColumnName + "=?";
	}

	@Override
	protected String getFindByExampleSelectShellOnlySQL() {
		return "SELECT thresholdexceedednotification.ID FROM ThresholdExceededNotification thresholdexceedednotification ";
	}
	...
	protected String getInsertIntoSQL() {
		return "INSERT INTO ThresholdExceededNotification (ID,externalID,message,name,date,type,agent_ID,lOBConfiguration_ID,teamLeader_ID,lOBConfigurationEntry_ID) VALUES (?,?,?,?,?,?,?,?,?,?)";
	}
	
	@Override
	protected String getUpdateSet() {
		return "UPDATE ThresholdExceededNotification SET externalID=?,message=?,name=?,date=?,type=?,agent_ID=?,lOBConfiguration_ID=?,teamLeader_ID=?,lOBConfigurationEntry_ID=? WHERE ID=?";
	}
	
	@Override
	protected String getDeleteFromSQL() {
		return "DELETE FROM ThresholdExceededNotification WHERE ID=?";
	}
