...
//	public static final String CONNECTION_FACTORY_NAME = "jdbc:mysql://pulse.cta6j6w4rrxw.us-west-2.rds.amazonaws.com:3306/Pulse?autoReconnect=true";
	...
	protected String getSelectShellOnlySQL() {
		return "SELECT THRESHOLD_EXCEEDED_NOTIFICATION.ID FROM THRESHOLD_EXCEEDED_NOTIFICATION THRESHOLD_EXCEEDED_NOTIFICATION WHERE THRESHOLD_EXCEEDED_NOTIFICATION.ID=?";
	}
	
	@Override
	protected String getSelectStarSQL() {
		return "SELECT THRESHOLD_EXCEEDED_NOTIFICATION.ID,THRESHOLD_EXCEEDED_NOTIFICATION.DATE,THRESHOLD_EXCEEDED_NOTIFICATION.MESSAGE,THRESHOLD_EXCEEDED_NOTIFICATION.NAME,THRESHOLD_EXCEEDED_NOTIFICATION.TYPE,THRESHOLD_EXCEEDED_NOTIFICATION.LOB_CONFIGURATION_ID,THRESHOLD_EXCEEDED_NOTIFICATION.AGENT_ID,THRESHOLD_EXCEEDED_NOTIFICATION.LOB_CONFIGURATION_ENTRY_ID,THRESHOLD_EXCEEDED_NOTIFICATION.TEAM_LEADER_ID FROM THRESHOLD_EXCEEDED_NOTIFICATION THRESHOLD_EXCEEDED_NOTIFICATION WHERE THRESHOLD_EXCEEDED_NOTIFICATION.ID=?";
	}
	
	@Override
	protected String getSelectAllShellOnlySQL() {
		return "SELECT THRESHOLD_EXCEEDED_NOTIFICATION.ID FROM THRESHOLD_EXCEEDED_NOTIFICATION THRESHOLD_EXCEEDED_NOTIFICATION ORDER BY ID";
	}
	
	@Override
	protected String getSelectAllShellOnlyWithLimitAndOffsetSQL() {
		return "SELECT THRESHOLD_EXCEEDED_NOTIFICATION.ID FROM THRESHOLD_EXCEEDED_NOTIFICATION THRESHOLD_EXCEEDED_NOTIFICATION ORDER BY THRESHOLD_EXCEEDED_NOTIFICATION.ID LIMIT ? OFFSET ?";
	}
	
	@Override
	protected String getSelectAllStarSQL() {
		return "SELECT THRESHOLD_EXCEEDED_NOTIFICATION.ID,THRESHOLD_EXCEEDED_NOTIFICATION.DATE,THRESHOLD_EXCEEDED_NOTIFICATION.MESSAGE,THRESHOLD_EXCEEDED_NOTIFICATION.NAME,THRESHOLD_EXCEEDED_NOTIFICATION.TYPE,THRESHOLD_EXCEEDED_NOTIFICATION.LOB_CONFIGURATION_ID,THRESHOLD_EXCEEDED_NOTIFICATION.AGENT_ID,THRESHOLD_EXCEEDED_NOTIFICATION.LOB_CONFIGURATION_ENTRY_ID,THRESHOLD_EXCEEDED_NOTIFICATION.TEAM_LEADER_ID FROM THRESHOLD_EXCEEDED_NOTIFICATION THRESHOLD_EXCEEDED_NOTIFICATION ORDER BY THRESHOLD_EXCEEDED_NOTIFICATION.ID";
	}
	
	@Override
	protected String getSelectAllStarWithLimitAndOffsetSQL() {
		return "SELECT THRESHOLD_EXCEEDED_NOTIFICATION.ID,THRESHOLD_EXCEEDED_NOTIFICATION.DATE,THRESHOLD_EXCEEDED_NOTIFICATION.MESSAGE,THRESHOLD_EXCEEDED_NOTIFICATION.NAME,THRESHOLD_EXCEEDED_NOTIFICATION.TYPE,THRESHOLD_EXCEEDED_NOTIFICATION.LOB_CONFIGURATION_ID,THRESHOLD_EXCEEDED_NOTIFICATION.AGENT_ID,THRESHOLD_EXCEEDED_NOTIFICATION.LOB_CONFIGURATION_ENTRY_ID,THRESHOLD_EXCEEDED_NOTIFICATION.TEAM_LEADER_ID FROM THRESHOLD_EXCEEDED_NOTIFICATION THRESHOLD_EXCEEDED_NOTIFICATION ORDER BY THRESHOLD_EXCEEDED_NOTIFICATION.ID LIMIT ? OFFSET ?";
	}
	
	@Override
	protected String getCountAllSQL() {
		return "SELECT COUNT(ID) FROM THRESHOLD_EXCEEDED_NOTIFICATION THRESHOLD_EXCEEDED_NOTIFICATION";
	}
	
	@Override
	protected String getSelectInStarSQL() {
		return "SELECT THRESHOLD_EXCEEDED_NOTIFICATION.ID,THRESHOLD_EXCEEDED_NOTIFICATION.DATE,THRESHOLD_EXCEEDED_NOTIFICATION.MESSAGE,THRESHOLD_EXCEEDED_NOTIFICATION.NAME,THRESHOLD_EXCEEDED_NOTIFICATION.TYPE,THRESHOLD_EXCEEDED_NOTIFICATION.LOB_CONFIGURATION_ID,THRESHOLD_EXCEEDED_NOTIFICATION.AGENT_ID,THRESHOLD_EXCEEDED_NOTIFICATION.LOB_CONFIGURATION_ENTRY_ID,THRESHOLD_EXCEEDED_NOTIFICATION.TEAM_LEADER_ID FROM THRESHOLD_EXCEEDED_NOTIFICATION THRESHOLD_EXCEEDED_NOTIFICATION WHERE THRESHOLD_EXCEEDED_NOTIFICATION.ID IN (?)";
	}
	
	@Override
	protected String getSelectInShellOnlySQL() {
		return "SELECT THRESHOLD_EXCEEDED_NOTIFICATION.ID FROM THRESHOLD_EXCEEDED_NOTIFICATION THRESHOLD_EXCEEDED_NOTIFICATION WHERE THRESHOLD_EXCEEDED_NOTIFICATION.ID IN (?)";
	}

	@Override
	protected String getSelectByRelationshipStarSQL(String joinColumnName) {
		return "SELECT THRESHOLD_EXCEEDED_NOTIFICATION.ID,THRESHOLD_EXCEEDED_NOTIFICATION.DATE,THRESHOLD_EXCEEDED_NOTIFICATION.MESSAGE,THRESHOLD_EXCEEDED_NOTIFICATION.NAME,THRESHOLD_EXCEEDED_NOTIFICATION.TYPE,THRESHOLD_EXCEEDED_NOTIFICATION.LOB_CONFIGURATION_ID,THRESHOLD_EXCEEDED_NOTIFICATION.AGENT_ID,THRESHOLD_EXCEEDED_NOTIFICATION.LOB_CONFIGURATION_ENTRY_ID,THRESHOLD_EXCEEDED_NOTIFICATION.TEAM_LEADER_ID FROM THRESHOLD_EXCEEDED_NOTIFICATION THRESHOLD_EXCEEDED_NOTIFICATION WHERE THRESHOLD_EXCEEDED_NOTIFICATION." + joinColumnName + "=?";
	}
	
	@Override
	protected String getSelectByRelationshipShellOnlySQL(String joinColumnName) {
		return "SELECT THRESHOLD_EXCEEDED_NOTIFICATION.ID FROM THRESHOLD_EXCEEDED_NOTIFICATION THRESHOLD_EXCEEDED_NOTIFICATION WHERE THRESHOLD_EXCEEDED_NOTIFICATION." + joinColumnName + "=?";
	}

	@Override
	protected String getFindByExampleSelectShellOnlySQL() {
		return "SELECT THRESHOLD_EXCEEDED_NOTIFICATION.ID FROM THRESHOLD_EXCEEDED_NOTIFICATION THRESHOLD_EXCEEDED_NOTIFICATION ";
	}
	...
	protected String getInsertIntoSQL() {
		return "INSERT INTO THRESHOLD_EXCEEDED_NOTIFICATION (ID,DATE,MESSAGE,NAME,TYPE,LOB_CONFIGURATION_ID,AGENT_ID,LOB_CONFIGURATION_ENTRY_ID,TEAM_LEADER_ID) VALUES (?,?,?,?,?,?,?,?,?)";
	}
	
	@Override
	protected String getUpdateSet() {
		return "UPDATE THRESHOLD_EXCEEDED_NOTIFICATION SET DATE=?,MESSAGE=?,NAME=?,TYPE=?,LOB_CONFIGURATION_ID=?,AGENT_ID=?,LOB_CONFIGURATION_ENTRY_ID=?,TEAM_LEADER_ID=? WHERE ID=?";
	}
	
	@Override
	protected String getDeleteFromSQL() {
		return "DELETE FROM THRESHOLD_EXCEEDED_NOTIFICATION WHERE ID=?";
	}
