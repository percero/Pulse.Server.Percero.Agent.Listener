...
//	public static final String CONNECTION_FACTORY_NAME = "jdbc:mysql://pulse.cta6j6w4rrxw.us-west-2.rds.amazonaws.com:3306/Pulse?autoReconnect=true";
	...
	protected String getSelectAllStarSQL() {
		return "SELECT CHANGES_NOT_APPROVED_NOTIFICATION.ID,CHANGES_NOT_APPROVED_NOTIFICATION.RESOLVED,CHANGES_NOT_APPROVED_NOTIFICATION.SHIFT_END_DATE,CHANGES_NOT_APPROVED_NOTIFICATION.IN_PROGRESS_STATE_COUNT,CHANGES_NOT_APPROVED_NOTIFICATION.NAME,CHANGES_NOT_APPROVED_NOTIFICATION.NOT_YET_STARTED_STATE_COUNT,CHANGES_NOT_APPROVED_NOTIFICATION.APPROVED_STATE_COUNT,CHANGES_NOT_APPROVED_NOTIFICATION.COMPLETE_STATE_COUNT,CHANGES_NOT_APPROVED_NOTIFICATION.DATE,CHANGES_NOT_APPROVED_NOTIFICATION.TYPE,CHANGES_NOT_APPROVED_NOTIFICATION.TEAM_LEADER_ID FROM CHANGES_NOT_APPROVED_NOTIFICATION CHANGES_NOT_APPROVED_NOTIFICATION ORDER BY CHANGES_NOT_APPROVED_NOTIFICATION.ID";
	}
	...
	protected String getFindByExampleSelectAllStarSQL() {
		return "SELECT CHANGES_NOT_APPROVED_NOTIFICATION.ID,CHANGES_NOT_APPROVED_NOTIFICATION.RESOLVED,CHANGES_NOT_APPROVED_NOTIFICATION.SHIFT_END_DATE,CHANGES_NOT_APPROVED_NOTIFICATION.IN_PROGRESS_STATE_COUNT,CHANGES_NOT_APPROVED_NOTIFICATION.NAME,CHANGES_NOT_APPROVED_NOTIFICATION.NOT_YET_STARTED_STATE_COUNT,CHANGES_NOT_APPROVED_NOTIFICATION.APPROVED_STATE_COUNT,CHANGES_NOT_APPROVED_NOTIFICATION.COMPLETE_STATE_COUNT,CHANGES_NOT_APPROVED_NOTIFICATION.DATE,CHANGES_NOT_APPROVED_NOTIFICATION.TYPE,CHANGES_NOT_APPROVED_NOTIFICATION.TEAM_LEADER_ID FROM CHANGES_NOT_APPROVED_NOTIFICATION CHANGES_NOT_APPROVED_NOTIFICATION ";
	}
	
	@Override
	protected String getInsertIntoSQL() {
		return "INSERT INTO CHANGES_NOT_APPROVED_NOTIFICATION (ID,RESOLVED,SHIFT_END_DATE,IN_PROGRESS_STATE_COUNT,NAME,NOT_YET_STARTED_STATE_COUNT,APPROVED_STATE_COUNT,COMPLETE_STATE_COUNT,DATE,TYPE,TEAM_LEADER_ID) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
	}
	
	@Override
	protected String getUpdateSet() {
		return "UPDATE CHANGES_NOT_APPROVED_NOTIFICATION SET RESOLVED=?,SHIFT_END_DATE=?,IN_PROGRESS_STATE_COUNT=?,NAME=?,NOT_YET_STARTED_STATE_COUNT=?,APPROVED_STATE_COUNT=?,COMPLETE_STATE_COUNT=?,DATE=?,TYPE=?,TEAM_LEADER_ID=? WHERE ID=?";
	}
