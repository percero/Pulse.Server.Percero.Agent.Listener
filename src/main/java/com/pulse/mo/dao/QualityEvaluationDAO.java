...
return "SELECT \"QUALITY_EVALUATION\".\"ID\" " + selectFromStatementTableName + joinAgentScorecardIDQualityEvaluation;
	...
	protected String getInsertIntoSQL() {
		return "INSERT INTO TBL_QUALITY_EVALUATION (\"ID\",\"UPDATED_BY\",\"CREATED_BY\",\"IS_REQUIRED\",\"CREATED_ON\",\"UPDATED_ON\",\"WEEK_DATE\",\"NICE_EVAL_ID\",\"EVALUATION_NAME\",\"MANUAL_DETAILS\",\"NICE_APP_SERVER\",\"RESPONSIBLE_COACH\",\"SCORECARD_ID\",\"AGENT_ID\",\"AGENT_SCORECARD_ID\",\"EMPLOYEE_ID\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	}
	
	@Override
	protected String getUpdateSet() {
		return "UPDATE TBL_QUALITY_EVALUATION SET \"UPDATED_BY\"=?,\"CREATED_BY\"=?,\"IS_REQUIRED\"=?,\"CREATED_ON\"=?,\"UPDATED_ON\"=?,\"WEEK_DATE\"=?,\"NICE_EVAL_ID\"=?,\"EVALUATION_NAME\"=?,\"MANUAL_DETAILS\"=?,\"NICE_APP_SERVER\"=?,\"RESPONSIBLE_COACH\"=?,\"SCORECARD_ID\"=?,\"AGENT_ID\"=?,\"AGENT_SCORECARD_ID\"=?,\"EMPLOYEE_ID\"=? WHERE \"ID\"=?";
	}
...
JdbcHelper.setInt(pstmt,8, perceroObject.getNiceEvalId());
pstmt.setString(9, perceroObject.getEvaluationName());
pstmt.setString(10, perceroObject.getManualDetails());
pstmt.setString(11, perceroObject.getNiceAppServer());
pstmt.setString(12, perceroObject.getResponsibleCoach());
...
{
		pstmt.setString(16, perceroObject.getEmployee().getID());
}
...
pstmt.setString(8, perceroObject.getEvaluationName());
pstmt.setString(9, perceroObject.getManualDetails());
pstmt.setString(10, perceroObject.getNiceAppServer());
pstmt.setString(11, perceroObject.getResponsibleCoach());
...
{
		pstmt.setString(15, perceroObject.getEmployee().getID());
}
