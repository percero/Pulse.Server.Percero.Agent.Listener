...
//	public static final String CONNECTION_FACTORY_NAME = "jdbc:mysql://pulse.cta6j6w4rrxw.us-west-2.rds.amazonaws.com:3306/Pulse?autoReconnect=true";
	...
	protected String getSelectStarSQL() {
		return "SELECT WORK_MODE_OCCURRENCE_NOTIFICATION.ID,WORK_MODE_OCCURRENCE_NOTIFICATION.LOGIN_COUNT,WORK_MODE_OCCURRENCE_NOTIFICATION.LOGOUT_COUNT,WORK_MODE_OCCURRENCE_NOTIFICATION.DATE,WORK_MODE_OCCURRENCE_NOTIFICATION.MESSAGE,WORK_MODE_OCCURRENCE_NOTIFICATION.NAME,WORK_MODE_OCCURRENCE_NOTIFICATION.TYPE,WORK_MODE_OCCURRENCE_NOTIFICATION.AGENT_ID,WORK_MODE_OCCURRENCE_NOTIFICATION.LOB_CONFIGURATION_ID,WORK_MODE_OCCURRENCE_NOTIFICATION.LOB_CONFIGURATION_ENTRY_ID,WORK_MODE_OCCURRENCE_NOTIFICATION.TEAM_LEADER_ID FROM WORK_MODE_OCCURRENCE_NOTIFICATION WORK_MODE_OCCURRENCE_NOTIFICATION WHERE WORK_MODE_OCCURRENCE_NOTIFICATION.ID=?";
	}
	...
	protected String getInsertIntoSQL() {
		return "INSERT INTO WORK_MODE_OCCURRENCE_NOTIFICATION (ID,LOGIN_COUNT,LOGOUT_COUNT,DATE,MESSAGE,NAME,TYPE,AGENT_ID,LOB_CONFIGURATION_ID,LOB_CONFIGURATION_ENTRY_ID,TEAM_LEADER_ID) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
	}
	
	@Override
	protected String getUpdateSet() {
		return "UPDATE WORK_MODE_OCCURRENCE_NOTIFICATION SET LOGIN_COUNT=?,LOGOUT_COUNT=?,DATE=?,MESSAGE=?,NAME=?,TYPE=?,AGENT_ID,LOB_CONFIGURATION_ID,LOB_CONFIGURATION_ENTRY_ID,TEAM_LEADER_ID WHERE ID=?";
	}
...
else
{
	...
	protected void setPreparedStatmentUpdateParams(WorkModeOccurrenceNotification perceroObject, PreparedStatement pstmt) throws SQLException {
		...
		pstmt.setInt(1, perceroObject.getLoginCount());
pstmt.setInt(2, perceroObject.getLogoutCount());
