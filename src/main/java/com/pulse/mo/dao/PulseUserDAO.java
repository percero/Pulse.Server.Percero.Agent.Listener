...
nextResult.setTeamLeader(teamleader);
	...
	protected void setBaseStatmentInsertParams(PulseUser perceroObject, PreparedStatement pstmt) throws SQLException {
...
else
{
	...
	@Override
	protected void setCallableStatmentInsertParams(PulseUser perceroObject, CallableStatement pstmt) throws SQLException {
...
pstmt.setString(6, perceroObject.getID());
	...
	@Override
	protected void setCallableStatmentUpdateParams(PulseUser perceroObject, CallableStatement pstmt) throws SQLException 
	{
...
propertyCounter++;
	...
	protected String getUpdateCallableStatementSql() {
		return "{call UPDATE_PULSE_USER(?,?,?,?,?,?)}";
	}
	@Override
	protected String getInsertCallableStatementSql() {
		return "{call CREATE_PULSE_USER(?,?,?,?,?,?)}";
	}
	@Override
	protected String getDeleteCallableStatementSql() {
		return "{call Delete_PULSE_USER(?)}";
	}
