...
//	public static final String CONNECTION_FACTORY_NAME = "jdbc:mysql://pulse.cta6j6w4rrxw.us-west-2.rds.amazonaws.com:3306/Pulse?autoReconnect=true";
	...
	protected String getSelectStarSQL() {
		return "SELECT INVALID_ACTIVITY_CODE_NOTIFICATION.ID,INVALID_ACTIVITY_CODE_NOTIFICATION.DATE,INVALID_ACTIVITY_CODE_NOTIFICATION.MESSAGE,INVALID_ACTIVITY_CODE_NOTIFICATION.NAME,INVALID_ACTIVITY_CODE_NOTIFICATION.TYPE,INVALID_ACTIVITY_CODE_NOTIFICATION.AGENT_ID,INVALID_ACTIVITY_CODE_NOTIFICATION.LOB_CONFIGURATION_ID,INVALID_ACTIVITY_CODE_NOTIFICATION.LOB_CONFIGURATION_ENTRY_ID,INVALID_ACTIVITY_CODE_NOTIFICATION.TEAM_LEADER_ID FROM INVALID_ACTIVITY_CODE_NOTIFICATION INVALID_ACTIVITY_CODE_NOTIFICATION WHERE INVALID_ACTIVITY_CODE_NOTIFICATION.ID=?";
	}
	...
	protected String getInsertIntoSQL() {
		return "INSERT INTO INVALID_ACTIVITY_CODE_NOTIFICATION (ID,DATE,MESSAGE,NAME,TYPE,AGENT_ID,LOB_CONFIGURATION_ID,LOB_CONFIGURATION_ENTRY_ID,TEAM_LEADER_ID) VALUES (?,?,?,?,?,?,?,?,?)";
	}
	
	@Override
	protected String getUpdateSet() {
		return "UPDATE INVALID_ACTIVITY_CODE_NOTIFICATION SET DATE=?,MESSAGE=?,NAME=?,TYPE=?,AGENT_ID,LOB_CONFIGURATION_ID,LOB_CONFIGURATION_ENTRY_ID,TEAM_LEADER_ID WHERE ID=?";
	}
