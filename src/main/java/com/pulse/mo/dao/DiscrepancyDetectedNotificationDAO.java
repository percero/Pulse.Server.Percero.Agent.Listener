...
//	public static final String CONNECTION_FACTORY_NAME = "jdbc:mysql://pulse.cta6j6w4rrxw.us-west-2.rds.amazonaws.com:3306/Pulse?autoReconnect=true";
	...
	protected String getSelectStarSQL() {
		return "SELECT DISCREPANCY_DETECTED_NOTIFICATION.ID,DISCREPANCY_DETECTED_NOTIFICATION.AUX_CODE_ENTRY_NAME,DISCREPANCY_DETECTED_NOTIFICATION.DATE,DISCREPANCY_DETECTED_NOTIFICATION.MESSAGE,DISCREPANCY_DETECTED_NOTIFICATION.NAME,DISCREPANCY_DETECTED_NOTIFICATION.TIMECARD_ACTIVITY_NAME,DISCREPANCY_DETECTED_NOTIFICATION.TYPE,DISCREPANCY_DETECTED_NOTIFICATION.AGENT_ID,DISCREPANCY_DETECTED_NOTIFICATION.LOB_CONFIGURATION_ID,DISCREPANCY_DETECTED_NOTIFICATION.CMS_AUX_MODE_ID,DISCREPANCY_DETECTED_NOTIFICATION.TEAM_LEADER_ID,DISCREPANCY_DETECTED_NOTIFICATION.TIMECARD_ACTIVITY_ID FROM DISCREPANCY_DETECTED_NOTIFICATION DISCREPANCY_DETECTED_NOTIFICATION WHERE DISCREPANCY_DETECTED_NOTIFICATION.ID=?";
	}
	...
	protected String getInsertIntoSQL() {
		return "INSERT INTO DISCREPANCY_DETECTED_NOTIFICATION (ID,AUX_CODE_ENTRY_NAME,DATE,MESSAGE,NAME,TIMECARD_ACTIVITY_NAME,TYPE,AGENT_ID,LOB_CONFIGURATION_ID,CMS_AUX_MODE_ID,TEAM_LEADER_ID,TIMECARD_ACTIVITY_ID) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
	}
	
	@Override
	protected String getUpdateSet() {
		return "UPDATE DISCREPANCY_DETECTED_NOTIFICATION SET AUX_CODE_ENTRY_NAME=?,DATE=?,MESSAGE=?,NAME=?,TIMECARD_ACTIVITY_NAME=?,TYPE=?,AGENT_ID,LOB_CONFIGURATION_ID,CMS_AUX_MODE_ID,TEAM_LEADER_ID,TIMECARD_ACTIVITY_ID WHERE ID=?";
	}
