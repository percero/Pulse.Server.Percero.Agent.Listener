...
//	public static final String CONNECTION_FACTORY_NAME = "jdbc:mysql://pulse.cta6j6w4rrxw.us-west-2.rds.amazonaws.com:3306/Pulse?autoReconnect=true";
	...
	protected String getSelectShellOnlySQL() {
		return "SELECT LOB_CONFIGURATION_NOTIFICATION.ID FROM LOB_CONFIGURATION_NOTIFICATION LOB_CONFIGURATION_NOTIFICATION WHERE LOB_CONFIGURATION_NOTIFICATION.ID=?";
	}
	
	@Override
	protected String getSelectStarSQL() {
		return "SELECT LOB_CONFIGURATION_NOTIFICATION.ID,LOB_CONFIGURATION_NOTIFICATION.DATE,LOB_CONFIGURATION_NOTIFICATION.MESSAGE,LOB_CONFIGURATION_NOTIFICATION.NAME,LOB_CONFIGURATION_NOTIFICATION.TYPE,LOB_CONFIGURATION_NOTIFICATION.AGENT_ID,LOB_CONFIGURATION_NOTIFICATION.LOB_CONFIGURATION_ID,LOB_CONFIGURATION_NOTIFICATION.TEAM_LEADER_ID FROM LOB_CONFIGURATION_NOTIFICATION LOB_CONFIGURATION_NOTIFICATION WHERE LOB_CONFIGURATION_NOTIFICATION.ID=?";
	}
	
	@Override
	protected String getSelectAllShellOnlySQL() {
		return "SELECT LOB_CONFIGURATION_NOTIFICATION.ID FROM LOB_CONFIGURATION_NOTIFICATION LOB_CONFIGURATION_NOTIFICATION ORDER BY ID";
	}
	
	@Override
	protected String getSelectAllShellOnlyWithLimitAndOffsetSQL() {
		return "SELECT LOB_CONFIGURATION_NOTIFICATION.ID FROM LOB_CONFIGURATION_NOTIFICATION LOB_CONFIGURATION_NOTIFICATION ORDER BY LOB_CONFIGURATION_NOTIFICATION.ID LIMIT ? OFFSET ?";
	}
	
	@Override
	protected String getSelectAllStarSQL() {
		return "SELECT LOB_CONFIGURATION_NOTIFICATION.ID,LOB_CONFIGURATION_NOTIFICATION.DATE,LOB_CONFIGURATION_NOTIFICATION.MESSAGE,LOB_CONFIGURATION_NOTIFICATION.NAME,LOB_CONFIGURATION_NOTIFICATION.TYPE,LOB_CONFIGURATION_NOTIFICATION.AGENT_ID,LOB_CONFIGURATION_NOTIFICATION.LOB_CONFIGURATION_ID,LOB_CONFIGURATION_NOTIFICATION.TEAM_LEADER_ID FROM LOB_CONFIGURATION_NOTIFICATION LOB_CONFIGURATION_NOTIFICATION ORDER BY LOB_CONFIGURATION_NOTIFICATION.ID";
	}
	...
	protected String getCountAllSQL() {
		return "SELECT COUNT(ID) FROM LOB_CONFIGURATION_NOTIFICATION LOB_CONFIGURATION_NOTIFICATION";
	}
	
	@Override
	protected String getSelectInStarSQL() {
		return "SELECT LOB_CONFIGURATION_NOTIFICATION.ID,LOB_CONFIGURATION_NOTIFICATION.DATE,LOB_CONFIGURATION_NOTIFICATION.MESSAGE,LOB_CONFIGURATION_NOTIFICATION.NAME,LOB_CONFIGURATION_NOTIFICATION.TYPE,LOB_CONFIGURATION_NOTIFICATION.AGENT_ID,LOB_CONFIGURATION_NOTIFICATION.LOB_CONFIGURATION_ID,LOB_CONFIGURATION_NOTIFICATION.TEAM_LEADER_ID FROM LOB_CONFIGURATION_NOTIFICATION LOB_CONFIGURATION_NOTIFICATION WHERE LOB_CONFIGURATION_NOTIFICATION.ID IN (?)";
	}
	
	@Override
	protected String getSelectInShellOnlySQL() {
		return "SELECT LOB_CONFIGURATION_NOTIFICATION.ID FROM LOB_CONFIGURATION_NOTIFICATION LOB_CONFIGURATION_NOTIFICATION WHERE LOB_CONFIGURATION_NOTIFICATION.ID IN (?)";
	}

	@Override
	protected String getSelectByRelationshipStarSQL(String joinColumnName) {
		return "SELECT LOB_CONFIGURATION_NOTIFICATION.ID,LOB_CONFIGURATION_NOTIFICATION.DATE,LOB_CONFIGURATION_NOTIFICATION.MESSAGE,LOB_CONFIGURATION_NOTIFICATION.NAME,LOB_CONFIGURATION_NOTIFICATION.TYPE,LOB_CONFIGURATION_NOTIFICATION.AGENT_ID,LOB_CONFIGURATION_NOTIFICATION.LOB_CONFIGURATION_ID,LOB_CONFIGURATION_NOTIFICATION.TEAM_LEADER_ID FROM LOB_CONFIGURATION_NOTIFICATION LOB_CONFIGURATION_NOTIFICATION WHERE LOB_CONFIGURATION_NOTIFICATION." + joinColumnName + "=?";
	}
	
	@Override
	protected String getSelectByRelationshipShellOnlySQL(String joinColumnName) {
		return "SELECT LOB_CONFIGURATION_NOTIFICATION.ID FROM LOB_CONFIGURATION_NOTIFICATION LOB_CONFIGURATION_NOTIFICATION WHERE LOB_CONFIGURATION_NOTIFICATION." + joinColumnName + "=?";
	}

	@Override
	protected String getFindByExampleSelectShellOnlySQL() {
		return "SELECT LOB_CONFIGURATION_NOTIFICATION.ID FROM LOB_CONFIGURATION_NOTIFICATION LOB_CONFIGURATION_NOTIFICATION ";
	}

	@Override
	protected String getFindByExampleSelectAllStarSQL() {
		return "SELECT LOB_CONFIGURATION_NOTIFICATION.ID,LOB_CONFIGURATION_NOTIFICATION.DATE,LOB_CONFIGURATION_NOTIFICATION.MESSAGE,LOB_CONFIGURATION_NOTIFICATION.NAME,LOB_CONFIGURATION_NOTIFICATION.TYPE,LOB_CONFIGURATION_NOTIFICATION.AGENT_ID,LOB_CONFIGURATION_NOTIFICATION.LOB_CONFIGURATION_ID,LOB_CONFIGURATION_NOTIFICATION.TEAM_LEADER_ID FROM LOB_CONFIGURATION_NOTIFICATION LOB_CONFIGURATION_NOTIFICATION ";
	}
	
	@Override
	protected String getInsertIntoSQL() {
		return "INSERT INTO LOB_CONFIGURATION_NOTIFICATION (ID,DATE,MESSAGE,NAME,TYPE,AGENT_ID,LOB_CONFIGURATION_ID,TEAM_LEADER_ID) VALUES (?,?,?,?,?,?,?,?)";
	}
	...
	protected String getDeleteFromSQL() {
		return "DELETE FROM LOB_CONFIGURATION_NOTIFICATION WHERE ID=?";
	}
