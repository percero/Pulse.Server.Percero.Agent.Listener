...
//	public static final String CONNECTION_FACTORY_NAME = "jdbc:mysql://pulse.cta6j6w4rrxw.us-west-2.rds.amazonaws.com:3306/Pulse?autoReconnect=true";
	...
	protected String getSelectStarSQL() {
		return "SELECT DURATION_TOLERANCE_NOTIFICATION.ID,DURATION_TOLERANCE_NOTIFICATION.DATE,DURATION_TOLERANCE_NOTIFICATION.MESSAGE,DURATION_TOLERANCE_NOTIFICATION.NAME,DURATION_TOLERANCE_NOTIFICATION.TYPE,DURATION_TOLERANCE_NOTIFICATION.LOB_CONFIGURATION_ID,DURATION_TOLERANCE_NOTIFICATION.AGENT_ID,DURATION_TOLERANCE_NOTIFICATION.LOB_CONFIGURATION_ENTRY_ID,DURATION_TOLERANCE_NOTIFICATION.TEAM_LEADER_ID FROM DURATION_TOLERANCE_NOTIFICATION DURATION_TOLERANCE_NOTIFICATION WHERE DURATION_TOLERANCE_NOTIFICATION.ID=?";
	}
	...
	protected String getInsertIntoSQL() {
		return "INSERT INTO DURATION_TOLERANCE_NOTIFICATION (ID,DATE,MESSAGE,NAME,TYPE,LOB_CONFIGURATION_ID,AGENT_ID,LOB_CONFIGURATION_ENTRY_ID,TEAM_LEADER_ID) VALUES (?,?,?,?,?,?,?,?,?)";
	}
	
	@Override
	protected String getUpdateSet() {
		return "UPDATE DURATION_TOLERANCE_NOTIFICATION SET DATE=?,MESSAGE=?,NAME=?,TYPE=?,LOB_CONFIGURATION_ID=?,AGENT_ID=?,LOB_CONFIGURATION_ENTRY_ID=?,TEAM_LEADER_ID=? WHERE ID=?";
	}
