...
//	public static final String CONNECTION_FACTORY_NAME = "jdbc:mysql://pulse.cta6j6w4rrxw.us-west-2.rds.amazonaws.com:3306/Pulse?autoReconnect=true";
	...
	public static final String SHELL_ONLY_SELECT = "\"MEASURE\".\"ID\"";
	...
	protected String getSelectByRelationshipShellOnlySQL(String joinColumnName) 
	{
		...
		return "SELECT " + SHELL_ONLY_SELECT + " " + selectFromStatementTableName + " WHERE \"MEASURE\"." + joinColumnName + "=?";
	}
	...
	protected String getInsertIntoSQL() {
		return "INSERT INTO TBL_MEASURE (\"ID\",\"NAME\") VALUES (?,?)";
	}
	
	@Override
	protected String getUpdateSet() {
		return "UPDATE TBL_MEASURE SET \"NAME\"=? WHERE \"ID\"=?";
	}
	
	@Override
	protected String getDeleteFromSQL() {
		return "DELETE FROM TBL_MEASURE WHERE \"ID\"=?";
	}
...
Measure nextResult = null;
    	
		    	
    	if (nextResult == null) {
    		nextResult = new Measure();
    	}
	...
	protected void setBaseStatmentInsertParams(Measure perceroObject, PreparedStatement pstmt) throws SQLException {
...
pstmt.setString(2, perceroObject.getName());
	...
	@Override
	protected void setCallableStatmentInsertParams(Measure perceroObject, CallableStatement pstmt) throws SQLException {
...
pstmt.setString(2, perceroObject.getID());
	...
	@Override
	protected void setCallableStatmentUpdateParams(Measure perceroObject, CallableStatement pstmt) throws SQLException 
	{
...
propertyCounter++;
	...
	protected String getUpdateCallableStatementSql() {
		return "{call UPDATE_MEASURE(?,?)}";
	}
	@Override
	protected String getInsertCallableStatementSql() {
		return "{call CREATE_MEASURE(?,?)}";
	}
	@Override
	protected String getDeleteCallableStatementSql() {
		return "{call Delete_MEASURE(?)}";
	}
	
	
public Measure createObject(Measure perceroObject, String userId)
	...
	Statement stmt = null;
	String query = "Select MEASURE_SEQ.NEXTVAL from dual";
	String sql = null;
	String insertedId = "0";
	int result = 0;
	try {
