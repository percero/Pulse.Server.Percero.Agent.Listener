...
//	public static final String CONNECTION_FACTORY_NAME = "jdbc:mysql://pulse.cta6j6w4rrxw.us-west-2.rds.amazonaws.com:3306/Pulse?autoReconnect=true";
    ...
    public static final String SQL_VIEW = ",\"LOB_CONFIGURATION_ENTRY\".\"TYPE\",\"LOB_CONFIGURATION_ENTRY\".\"MAX\",\"LOB_CONFIGURATION_ENTRY\".\"MIN\",\"LOB_CONFIGURATION_ENTRY\".\"OCCURRENCE\",\"LOB_CONFIGURATION_ENTRY\".\"CMS_AUX_CODE\",\"LOB_CONFIGURATION_ENTRY\".\"ESTART_ACTIVITY_CODE\",\"LOB_CONFIGURATION_ENTRY\".\"LOB_CONFIGURATION_ID\",\"LOB_CONFIGURATION_ENTRY\".\"NOTIFICATION_FREQUENCY_ID\"";
    ...
    protected String getInsertIntoSQL() {
        return "INSERT INTO TBL_LOB_CONFIGURATION_ENTRY (\"ID\",\"TYPE\",\"MAX\",\"MIN\",\"OCCURRENCE\",\"CMS_AUX_CODE\",\"ESTART_ACTIVITY_CODE\",\"LOB_CONFIGURATION_ID\",\"NOTIFICATION_FREQUENCY_ID\") VALUES (?,?,?,?,?,?,?,?,?)";
    }

    @Override
    protected String getUpdateSet() {
        return "UPDATE TBL_LOB_CONFIGURATION_ENTRY SET \"TYPE\"=?,\"MAX\"=?,\"MIN\"=?,\"OCCURRENCE\"=?,\"CMS_AUX_CODE\"=?,\"ESTART_ACTIVITY_CODE\"=?,\"LOB_CONFIGURATION_ID\"=?,\"NOTIFICATION_FREQUENCY_ID\"=? WHERE \"ID\"=?";
    }
    ...
    protected LOBConfigurationEntry extractObjectFromResultSet(ResultSet rs, Boolean shellOnly) throws SQLException {
        ...
        if (!shellOnly) {
            ...
            nextResult.setMax(rs.getString("MAX"));


            nextResult.setMin(rs.getString("MIN"));


            nextResult.setOccurrence(rs.getString("OCCURRENCE"));
    ...
    protected void setBaseStatmentInsertParams(LOBConfigurationEntry perceroObject, PreparedStatement pstmt) throws SQLException {
        ...
        pstmt.setString(3, perceroObject.getMax());
        pstmt.setString(4, perceroObject.getMin());
        pstmt.setString(5, perceroObject.getOccurrence());
        pstmt.setString(6, perceroObject.getCMSAuxCode());
        pstmt.setString(7, perceroObject.getESTARTActivityCode());
    ...
    protected void setPreparedStatmentUpdateParams(LOBConfigurationEntry perceroObject, PreparedStatement pstmt) throws SQLException {
        ...
        pstmt.setString(2, perceroObject.getMax());
        pstmt.setString(3, perceroObject.getMin());
        pstmt.setString(4, perceroObject.getOccurrence());
        pstmt.setString(5, perceroObject.getCMSAuxCode());
        pstmt.setString(6, perceroObject.getESTARTActivityCode());
    ...
    public List<LOBConfigurationEntry> findByExample(LOBConfigurationEntry theQueryObject,
        ...
        boolean useCMSAuxCode = StringUtils.hasText(theQueryObject.getCMSAuxCode()) && (excludeProperties == null || !excludeProperties.contains("cMSAuxCode"));
        ...
        boolean useESTARTActivityCode = StringUtils.hasText(theQueryObject.getESTARTActivityCode()) && (excludeProperties == null || !excludeProperties.contains("eSTARTActivityCode"));
