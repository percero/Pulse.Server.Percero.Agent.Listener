...
//	public static final String CONNECTION_FACTORY_NAME = "jdbc:mysql://pulse.cta6j6w4rrxw.us-west-2.rds.amazonaws.com:3306/Pulse?autoReconnect=true";
	...
	protected String getInsertIntoSQL() {
		return "INSERT INTO LOB_CONFIGURATION_ENTRY (\"ID\",\"DURATION_TOLERANCE_ENABLED\",\"DURATION_TOLERANCE\",\"DURATION_TOLERANCE_INTERVAL\",\"OCCURRENCE_TOLERANCE_INTERVAL\",\"REMINDER_INTERVAL\",\"LOB_CONFIGURATION_ID\",\"NOTIFICATION_FREQUENCY_ID\") VALUES (?,?,?,?,?,?,?,?)";
	}
	
	@Override
	protected String getUpdateSet() {
		return "UPDATE \"LOB_CONFIGURATION_ENTRY\" SET \"DURATION_TOLERANCE_ENABLED\"=?,\"DURATION_TOLERANCE\"=?,\"DURATION_TOLERANCE_INTERVAL\"=?,\"OCCURRENCE_TOLERANCE_INTERVAL\"=?,\"REMINDER_INTERVAL\"=?,\"LOB_CONFIGURATION_ID\"=?,\"NOTIFICATION_FREQUENCY_ID\"=? WHERE \"ID\"=?";
	}
