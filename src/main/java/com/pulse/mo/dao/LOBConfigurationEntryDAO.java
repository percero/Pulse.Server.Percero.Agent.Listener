...
JdbcHelper.setInt(pstmt,3, perceroObject.getMax());
JdbcHelper.setInt(pstmt,4, perceroObject.getMin());
JdbcHelper.setInt(pstmt,5, perceroObject.getOccurrence());
...
JdbcHelper.setInt(pstmt,2, perceroObject.getMax());
JdbcHelper.setInt(pstmt,3, perceroObject.getMin());
JdbcHelper.setInt(pstmt,4, perceroObject.getOccurrence());
