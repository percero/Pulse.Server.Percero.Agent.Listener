...
//	public static final String CONNECTION_FACTORY_NAME = "jdbc:mysql://pulse.cta6j6w4rrxw.us-west-2.rds.amazonaws.com:3306/Pulse?autoReconnect=true";
	...
	protected String getSelectStarSQL() {
		return "SELECT LOB_CONFIGURATION_ENTRY.ID,LOB_CONFIGURATION_ENTRY.DURATION_TOLERANCE_ENABLED,LOB_CONFIGURATION_ENTRY.DURATION_TOLERANCE,LOB_CONFIGURATION_ENTRY.DURATION_TOLERANCE_INTERVAL,LOB_CONFIGURATION_ENTRY.OCCURRENCE_TOLERANCE_INTERVAL,LOB_CONFIGURATION_ENTRY.REMINDER_INTERVAL,LOB_CONFIGURATION_ENTRY.CMS_AUX_MODE_ID,LOB_CONFIGURATION_ENTRY.LOB_CONFIGURATION_ID,LOB_CONFIGURATION_ENTRY.NOTIFICATION_FREQUENCY_ID,LOB_CONFIGURATION_ENTRY.TIMECARD_ACTIVITY_ID FROM LOB_CONFIGURATION_ENTRY LOB_CONFIGURATION_ENTRY WHERE LOB_CONFIGURATION_ENTRY.ID=?";
	}
	...
	protected String getSelectAllStarSQL() {
		return "SELECT LOB_CONFIGURATION_ENTRY.ID,LOB_CONFIGURATION_ENTRY.DURATION_TOLERANCE_ENABLED,LOB_CONFIGURATION_ENTRY.DURATION_TOLERANCE,LOB_CONFIGURATION_ENTRY.DURATION_TOLERANCE_INTERVAL,LOB_CONFIGURATION_ENTRY.OCCURRENCE_TOLERANCE_INTERVAL,LOB_CONFIGURATION_ENTRY.REMINDER_INTERVAL,LOB_CONFIGURATION_ENTRY.CMS_AUX_MODE_ID,LOB_CONFIGURATION_ENTRY.LOB_CONFIGURATION_ID,LOB_CONFIGURATION_ENTRY.NOTIFICATION_FREQUENCY_ID,LOB_CONFIGURATION_ENTRY.TIMECARD_ACTIVITY_ID FROM LOB_CONFIGURATION_ENTRY LOB_CONFIGURATION_ENTRY ORDER BY LOB_CONFIGURATION_ENTRY.ID";
	}
	
	@Override
	protected String getSelectAllStarWithLimitAndOffsetSQL() {
		return "SELECT LOB_CONFIGURATION_ENTRY.ID,LOB_CONFIGURATION_ENTRY.DURATION_TOLERANCE_ENABLED,LOB_CONFIGURATION_ENTRY.DURATION_TOLERANCE,LOB_CONFIGURATION_ENTRY.DURATION_TOLERANCE_INTERVAL,LOB_CONFIGURATION_ENTRY.OCCURRENCE_TOLERANCE_INTERVAL,LOB_CONFIGURATION_ENTRY.REMINDER_INTERVAL,LOB_CONFIGURATION_ENTRY.CMS_AUX_MODE_ID,LOB_CONFIGURATION_ENTRY.LOB_CONFIGURATION_ID,LOB_CONFIGURATION_ENTRY.NOTIFICATION_FREQUENCY_ID,LOB_CONFIGURATION_ENTRY.TIMECARD_ACTIVITY_ID FROM LOB_CONFIGURATION_ENTRY LOB_CONFIGURATION_ENTRY ORDER BY LOB_CONFIGURATION_ENTRY.ID LIMIT ? OFFSET ?";
	}
	...
	protected String getSelectInStarSQL() {
		return "SELECT LOB_CONFIGURATION_ENTRY.ID,LOB_CONFIGURATION_ENTRY.DURATION_TOLERANCE_ENABLED,LOB_CONFIGURATION_ENTRY.DURATION_TOLERANCE,LOB_CONFIGURATION_ENTRY.DURATION_TOLERANCE_INTERVAL,LOB_CONFIGURATION_ENTRY.OCCURRENCE_TOLERANCE_INTERVAL,LOB_CONFIGURATION_ENTRY.REMINDER_INTERVAL,LOB_CONFIGURATION_ENTRY.CMS_AUX_MODE_ID,LOB_CONFIGURATION_ENTRY.LOB_CONFIGURATION_ID,LOB_CONFIGURATION_ENTRY.NOTIFICATION_FREQUENCY_ID,LOB_CONFIGURATION_ENTRY.TIMECARD_ACTIVITY_ID FROM LOB_CONFIGURATION_ENTRY LOB_CONFIGURATION_ENTRY WHERE LOB_CONFIGURATION_ENTRY.ID IN (?)";
	}
	...
	protected String getSelectByRelationshipStarSQL(String joinColumnName) {
		return "SELECT LOB_CONFIGURATION_ENTRY.ID,LOB_CONFIGURATION_ENTRY.DURATION_TOLERANCE_ENABLED,LOB_CONFIGURATION_ENTRY.DURATION_TOLERANCE,LOB_CONFIGURATION_ENTRY.DURATION_TOLERANCE_INTERVAL,LOB_CONFIGURATION_ENTRY.OCCURRENCE_TOLERANCE_INTERVAL,LOB_CONFIGURATION_ENTRY.REMINDER_INTERVAL,LOB_CONFIGURATION_ENTRY.CMS_AUX_MODE_ID,LOB_CONFIGURATION_ENTRY.LOB_CONFIGURATION_ID,LOB_CONFIGURATION_ENTRY.NOTIFICATION_FREQUENCY_ID,LOB_CONFIGURATION_ENTRY.TIMECARD_ACTIVITY_ID FROM LOB_CONFIGURATION_ENTRY LOB_CONFIGURATION_ENTRY WHERE LOB_CONFIGURATION_ENTRY." + joinColumnName + "=?";
	}
	...
	protected String getFindByExampleSelectAllStarSQL() {
		return "SELECT LOB_CONFIGURATION_ENTRY.ID,LOB_CONFIGURATION_ENTRY.DURATION_TOLERANCE_ENABLED,LOB_CONFIGURATION_ENTRY.DURATION_TOLERANCE,LOB_CONFIGURATION_ENTRY.DURATION_TOLERANCE_INTERVAL,LOB_CONFIGURATION_ENTRY.OCCURRENCE_TOLERANCE_INTERVAL,LOB_CONFIGURATION_ENTRY.REMINDER_INTERVAL,LOB_CONFIGURATION_ENTRY.CMS_AUX_MODE_ID,LOB_CONFIGURATION_ENTRY.LOB_CONFIGURATION_ID,LOB_CONFIGURATION_ENTRY.NOTIFICATION_FREQUENCY_ID,LOB_CONFIGURATION_ENTRY.TIMECARD_ACTIVITY_ID FROM LOB_CONFIGURATION_ENTRY LOB_CONFIGURATION_ENTRY ";
	}
	
	@Override
	protected String getInsertIntoSQL() {
		return "INSERT INTO LOB_CONFIGURATION_ENTRY (ID,DURATION_TOLERANCE_ENABLED,DURATION_TOLERANCE,DURATION_TOLERANCE_INTERVAL,OCCURRENCE_TOLERANCE_INTERVAL,REMINDER_INTERVAL,CMS_AUX_MODE_ID,LOB_CONFIGURATION_ID,NOTIFICATION_FREQUENCY_ID,TIMECARD_ACTIVITY_ID) VALUES (?,?,?,?,?,?,?,?,?,?)";
	}
	
	@Override
	protected String getUpdateSet() {
		return "UPDATE LOB_CONFIGURATION_ENTRY SET DURATION_TOLERANCE_ENABLED=?,DURATION_TOLERANCE=?,DURATION_TOLERANCE_INTERVAL=?,OCCURRENCE_TOLERANCE_INTERVAL=?,REMINDER_INTERVAL=?,CMS_AUX_MODE_ID,LOB_CONFIGURATION_ID,NOTIFICATION_FREQUENCY_ID,TIMECARD_ACTIVITY_ID WHERE ID=?";
	}
