...
//	public static final String CONNECTION_FACTORY_NAME = "jdbc:mysql://pulse.cta6j6w4rrxw.us-west-2.rds.amazonaws.com:3306/Pulse?autoReconnect=true";
	...
	protected String getSelectShellOnlySQL() {
		return "SELECT occurrencetolerancenotification.ID FROM OccurrenceToleranceNotification occurrencetolerancenotification WHERE occurrencetolerancenotification.ID=?";
	}
	
	@Override
	protected String getSelectStarSQL() {
		return "SELECT occurrencetolerancenotification.ID,occurrencetolerancenotification.externalID,occurrencetolerancenotification.message,occurrencetolerancenotification.name,occurrencetolerancenotification.date,occurrencetolerancenotification.type,occurrencetolerancenotification.agent_ID,occurrencetolerancenotification.lOBConfiguration_ID,occurrencetolerancenotification.teamLeader_ID,occurrencetolerancenotification.lOBConfigurationEntry_ID FROM OccurrenceToleranceNotification occurrencetolerancenotification WHERE occurrencetolerancenotification.ID=?";
	}
	
	@Override
	protected String getSelectAllShellOnlySQL() {
		return "SELECT occurrencetolerancenotification.ID FROM OccurrenceToleranceNotification occurrencetolerancenotification ORDER BY ID";
	}
	
	@Override
	protected String getSelectAllShellOnlyWithLimitAndOffsetSQL() {
		return "SELECT occurrencetolerancenotification.ID FROM OccurrenceToleranceNotification occurrencetolerancenotification ORDER BY occurrencetolerancenotification.ID LIMIT ? OFFSET ?";
	}
	
	@Override
	protected String getSelectAllStarSQL() {
		return "SELECT occurrencetolerancenotification.ID,occurrencetolerancenotification.externalID,occurrencetolerancenotification.message,occurrencetolerancenotification.name,occurrencetolerancenotification.date,occurrencetolerancenotification.type,occurrencetolerancenotification.agent_ID,occurrencetolerancenotification.lOBConfiguration_ID,occurrencetolerancenotification.teamLeader_ID,occurrencetolerancenotification.lOBConfigurationEntry_ID FROM OccurrenceToleranceNotification occurrencetolerancenotification ORDER BY occurrencetolerancenotification.ID";
	}
	...
	protected String getCountAllSQL() {
		return "SELECT COUNT(ID) FROM OccurrenceToleranceNotification occurrencetolerancenotification";
	}
	
	@Override
	protected String getSelectInStarSQL() {
		return "SELECT occurrencetolerancenotification.ID,occurrencetolerancenotification.externalID,occurrencetolerancenotification.message,occurrencetolerancenotification.name,occurrencetolerancenotification.date,occurrencetolerancenotification.type,occurrencetolerancenotification.agent_ID,occurrencetolerancenotification.lOBConfiguration_ID,occurrencetolerancenotification.teamLeader_ID,occurrencetolerancenotification.lOBConfigurationEntry_ID FROM OccurrenceToleranceNotification occurrencetolerancenotification WHERE occurrencetolerancenotification.ID IN (?)";
	}
	
	@Override
	protected String getSelectInShellOnlySQL() {
		return "SELECT occurrencetolerancenotification.ID FROM OccurrenceToleranceNotification occurrencetolerancenotification WHERE occurrencetolerancenotification.ID IN (?)";
	}

	@Override
	protected String getSelectByRelationshipStarSQL(String joinColumnName) {
		return "SELECT occurrencetolerancenotification.ID,occurrencetolerancenotification.externalID,occurrencetolerancenotification.message,occurrencetolerancenotification.name,occurrencetolerancenotification.date,occurrencetolerancenotification.type,occurrencetolerancenotification.agent_ID,occurrencetolerancenotification.lOBConfiguration_ID,occurrencetolerancenotification.teamLeader_ID,occurrencetolerancenotification.lOBConfigurationEntry_ID FROM OccurrenceToleranceNotification occurrencetolerancenotification WHERE occurrencetolerancenotification." + joinColumnName + "=?";
	}
	
	@Override
	protected String getSelectByRelationshipShellOnlySQL(String joinColumnName) {
		return "SELECT occurrencetolerancenotification.ID FROM OccurrenceToleranceNotification occurrencetolerancenotification WHERE occurrencetolerancenotification." + joinColumnName + "=?";
	}

	@Override
	protected String getFindByExampleSelectShellOnlySQL() {
		return "SELECT occurrencetolerancenotification.ID FROM OccurrenceToleranceNotification occurrencetolerancenotification ";
	}
	...
	protected String getInsertIntoSQL() {
		return "INSERT INTO OccurrenceToleranceNotification (ID,externalID,message,name,date,type,agent_ID,lOBConfiguration_ID,teamLeader_ID,lOBConfigurationEntry_ID) VALUES (?,?,?,?,?,?,?,?,?,?)";
	}
	
	@Override
	protected String getUpdateSet() {
		return "UPDATE OccurrenceToleranceNotification SET externalID=?,message=?,name=?,date=?,type=?,agent_ID=?,lOBConfiguration_ID=?,teamLeader_ID=?,lOBConfigurationEntry_ID=? WHERE ID=?";
	}
	
	@Override
	protected String getDeleteFromSQL() {
		return "DELETE FROM OccurrenceToleranceNotification WHERE ID=?";
	}
