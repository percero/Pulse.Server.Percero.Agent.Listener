...
//	public static final String CONNECTION_FACTORY_NAME = "jdbc:mysql://pulse.cta6j6w4rrxw.us-west-2.rds.amazonaws.com:3306/Pulse?autoReconnect=true";
	...
	protected String getSelectStarSQL() {
		return "SELECT OCCURRENCE_TOLERANCE_NOTIFICATION.ID,OCCURRENCE_TOLERANCE_NOTIFICATION.DATE,OCCURRENCE_TOLERANCE_NOTIFICATION.MESSAGE,OCCURRENCE_TOLERANCE_NOTIFICATION.NAME,OCCURRENCE_TOLERANCE_NOTIFICATION.TYPE,OCCURRENCE_TOLERANCE_NOTIFICATION.LOB_CONFIGURATION_ID,OCCURRENCE_TOLERANCE_NOTIFICATION.AGENT_ID,OCCURRENCE_TOLERANCE_NOTIFICATION.LOB_CONFIGURATION_ENTRY_ID,OCCURRENCE_TOLERANCE_NOTIFICATION.TEAM_LEADER_ID FROM OCCURRENCE_TOLERANCE_NOTIFICATION OCCURRENCE_TOLERANCE_NOTIFICATION WHERE OCCURRENCE_TOLERANCE_NOTIFICATION.ID=?";
	}
	...
	protected String getInsertIntoSQL() {
		return "INSERT INTO OCCURRENCE_TOLERANCE_NOTIFICATION (ID,DATE,MESSAGE,NAME,TYPE,LOB_CONFIGURATION_ID,AGENT_ID,LOB_CONFIGURATION_ENTRY_ID,TEAM_LEADER_ID) VALUES (?,?,?,?,?,?,?,?,?)";
	}
	
	@Override
	protected String getUpdateSet() {
		return "UPDATE OCCURRENCE_TOLERANCE_NOTIFICATION SET DATE=?,MESSAGE=?,NAME=?,TYPE=?,LOB_CONFIGURATION_ID=?,AGENT_ID=?,LOB_CONFIGURATION_ENTRY_ID=?,TEAM_LEADER_ID=? WHERE ID=?";
	}
