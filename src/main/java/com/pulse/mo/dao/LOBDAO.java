...
public class LOBDAO extends SqlDataAccessObject<LOB> implements IDataAccessObject<LOB> {
	...
	public static final String SQL_VIEW = "SELECT  \"LOB\".\"ID\" as \"ID\", \"LOB\".\"NAME\" as \"NAME\", '' as \"PULSE_CONFIGURATION_ID\", \"LOB\".\"CLIENT_ID\" as \"CLIENT_ID\", '' as \"CLIENT_SITE_ID\" FROM \"MOB_LOB_SITE_VW\" \"LOB\" ";
