...
import com.pulse.mo.mo_super._Super_ScorecardMonthlyScore;
import com.pulse.sync.cw.ScorecardMonthlyScoreCWHelper;

@Entity(name="ScorecardMonthlyScore")
public class ScorecardMonthlyScore extends _Super_ScorecardMonthlyScore
{
	public ScorecardMonthlyScore getPreviousScorecardMonthlyScore() {
		...
		ClassIDPair result = (ClassIDPair) cwh.get(ScorecardMonthlyScoreCWHelper.PREVIOUS_SCORECARD_MONTHLY_SCORE, new ClassIDPair(this.getID(), this.getClass().getCanonicalName()));
		...
		if (result != null)
		{
			...
			return (ScorecardMonthlyScore) dataProvider.findById(result, null);
		}
