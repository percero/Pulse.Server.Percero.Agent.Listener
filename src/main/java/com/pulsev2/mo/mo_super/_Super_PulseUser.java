...
import com.pulsev2.mo.Email;
import com.pulsev2.mo.UserRole;
...
@com.percero.agents.auth.vo.IUserAnchorA(
	...
	userIdFieldName="userId", userIdFieldType="String"
        				...
        				, 
    	identifiersFieldName="emails", identifiersFieldType="com.pulsev2.mo.Email"
        				, 
    	rolesFieldName="roles", rolesFieldType="com.pulsev2.mo.UserRole"
)
*/
