...
CREATE OR REPLACE FORCE VIEW "PULSEUSER"."DURATION_MISMATCH_NOTIF" ("ID", "TYPE", "AUX_CODE_ENTRY_NAME", "NAME", "END_TIME", "MESSAGE", "CREATED_ON", "DURATION", "LOB_CONFIGURATION_ID", "AGENT_ID", "TIMECARD_ACTIVITY_ID", "TEAM_LEADER_ID", "IS_READ")
                                                        AS
...
CREATE OR REPLACE FORCE VIEW "PULSEUSER"."OCCURRENCE_MISMATCH_NOTIF" ("ID", "TYPE", "AUX_CODE_ENTRY_NAME", "MESSAGE", "CREATED_ON", "NAME", "LOB_CONFIGURATION_ID", "AGENT_ID", "TIMECARD_ACTIVITY_ID", "TEAM_LEADER_ID", "IS_READ")
                                                        AS
  SELECT "DISCREPANCY_DETECTED_NOTIF"."ID"              AS "ID",
    "NOTIFICATION"."TYPE"                               AS "TYPE",
    "DISCREPANCY_DETECTED_NOTIF"."AUX_CODE_ENTRY_NAME"  AS "AUX_CODE_ENTRY_NAME",
