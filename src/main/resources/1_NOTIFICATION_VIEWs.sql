...
CREATE OR REPLACE FORCE VIEW "PULSEUSER"."DURATION_MISMATCH_NOTIF" ("ID", "TYPE", "AUX_CODE_ENTRY_NAME", "NAME", "END_TIME", "MESSAGE", "CREATED_ON", "DURATION", "LOB_CONFIGURATION_ID", "WORKED_ID", "AGENT_ID", "TIMECARD_ACTIVITY_ID", "TEAM_LEADER_ID", "IS_READ")
                                                        AS
...
("ID", "MESSAGE", "CREATED_ON", "NAME", "TYPE", "AGENT_ID", "LOB_CONFIGURATION_ID", "WORKED_ID", "LOB_CONFIGURATION_ENTRY_ID", "TEAM_LEADER_ID", "IS_READ")
                                                        AS
...
CREATE OR REPLACE FORCE VIEW "PULSEUSER"."INV_ACTVTY_CODE_NOTIF" ("ID", "TYPE", "NAME", "MESSAGE", "CREATED_ON", "AGENT_ID", "LOB_CONFIGURATION_ID","WORKED_ID", "LOB_CONFIGURATION_ENTRY_ID", "TEAM_LEADER_ID", "IS_READ")
                                                        AS
  SELECT "THRSH_EXCEEDED_NOTIF"."ID"                    AS "ID",
    "NOTIFICATION"."TYPE"                               AS "TYPE",
    "NOTIFICATION"."NAME"                               AS "NAME",
...
CREATE OR REPLACE FORCE VIEW "PULSEUSER"."NON_BILLABLE_ACTVTY_NOTIF" ("ID", "TYPE", "AUX_CODE_ENTRY_NAME", "MESSAGE", "CREATED_ON", "NAME", "LOB_CONFIGURATION_ID", "AGENT_ID", "WORKED_ID", "TEAM_LEADER_ID", "TIMECARD_ACTIVITY_ID", "IS_READ")
                                                        AS
  SELECT "DISCREPANCY_DETECTED_NOTIF"."ID"              AS "ID",
    "NOTIFICATION"."TYPE"                               AS "TYPE",
    "DISCREPANCY_DETECTED_NOTIF"."AUX_CODE_ENTRY_NAME"  AS "AUX_CODE_ENTRY_NAME",
...
CREATE OR REPLACE FORCE VIEW "PULSEUSER"."OCCURRENCE_MISMATCH_NOTIF" ("ID", "TYPE", "AUX_CODE_ENTRY_NAME", "MESSAGE", "CREATED_ON", "NAME", "LOB_CONFIGURATION_ID", "WORKED_ID", "AGENT_ID", "TIMECARD_ACTIVITY_ID", "TEAM_LEADER_ID", "IS_READ")
                                                        AS
  SELECT "DISCREPANCY_DETECTED_NOTIF"."ID"              AS "ID",
    "NOTIFICATION"."TYPE"                               AS "TYPE",
    "DISCREPANCY_DETECTED_NOTIF"."AUX_CODE_ENTRY_NAME"  AS "AUX_CODE_ENTRY_NAME",
...
CREATE OR REPLACE FORCE VIEW "PULSEUSER"."OCCURRENCE_TOLERANCE_NOTIF" ("ID", "MESSAGE", "CREATED_ON", "NAME", "TYPE", "AGENT_ID", "LOB_CONFIGURATION_ID",  "WORKED_ID", "LOB_CONFIGURATION_ENTRY_ID", "TEAM_LEADER_ID", "IS_READ")
                                                        AS
  SELECT "THRSH_EXCEEDED_NOTIF"."ID"                    AS "ID",
    "LOB_CONFIGURATION_NOTIF"."MESSAGE"                 AS "MESSAGE",
    "NOTIFICATION"."CREATED_ON"                         AS "CREATED_ON",
...
CREATE OR REPLACE FORCE VIEW "PULSEUSER"."THRSH_EXCEEDED_NOTIF" ("ID", "MESSAGE", "CREATED_ON", "NAME", "TYPE", "LOB_CONFIGURATION_ID", "AGENT_ID", "TEAM_LEADER_ID", "LOB_CONFIGURATION_ENTRY_ID", "IS_READ")
                                                        AS
  SELECT "THRSH_EXCEEDED_NOTIF"."ID"                    AS "ID",
    "LOB_CONFIGURATION_NOTIF"."MESSAGE"                 AS "MESSAGE",
    "NOTIFICATION"."CREATED_ON"                         AS "CREATED_ON",
