...
BEGIN
    ...
    BEGIN
        SELECT ORA_HASH(vType || vTimecard_Entry_ID) INTO vHashKey FROM DUAL;
          ...
          INSERT INTO TBL_LOB_CONFIGURATION_NOTIF (ID, MESSAGE, AGENT_ID, LOB_CONFIGURATION_ID, WORKED_ID, HASH_KEY, TIMECARD_ID)
            VALUES (vID, vMESSAGE, vAGENT_ID, vLOB_CONFIGURATION_ID, vTimecard_Entry_ID, vHashKey, vTimecard_ID);
