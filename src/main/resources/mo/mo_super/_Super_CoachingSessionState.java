...
@MappedSuperclass
public class _Super_CoachingSessionState extends BaseDataObject implements Serializable
{
	//////////////////////////////////////////////////////
	// VERSION
	//////////////////////////////////////////////////////
...
@OneToMany(fetch=FetchType.LAZY, targetEntity=CoachingSession.class, mappedBy="coachingSessionState", cascade=javax.persistence.CascadeType.REMOVE)
...
objectJson += ",\"coachingSessions\":[";
	...
	protected List<MappedClassMethodPair> getListSetters() {
		...
		// Target Relationships
		listSetters.add(MappedClass.getFieldSetters(CoachingSession.class, "coachingsessionstate"));
