...
INSERT INTO pulse.MOB_CMS_DATA(START_TIME, END_TIME, EVENT_DURATION, AUXREASON, SWI_CODE, LOGIN_ID, ID) VALUES( to_date(timecardDate||'13:04:00','DD-MON-yyyyHH24:mi:ss'), to_date(timecardDate||'15:07:00','DD-MON-yyyyHH24:mi:ss'), '63.48', '0', vSwiCode,vLoginId, vID);
